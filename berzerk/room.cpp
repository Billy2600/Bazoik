...
void Room::CreateWalls()
{
	...
	// Inside door area
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x - WALL_WIDTH, topLeft.y + WALL_HEIGHT), sf::Vector2f(WALL_WIDTH, WALL_THICKNESS), sf::Color::Red));
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x - WALL_WIDTH, topLeft.y + WALL_HEIGHT + DOOR_WIDTH), sf::Vector2f(WALL_WIDTH, WALL_THICKNESS), sf::Color::Red));
	...
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x + WALL_WIDTH - WALL_THICKNESS, topLeft.y - WALL_HEIGHT), sf::Vector2f(WALL_THICKNESS, WALL_HEIGHT), sf::Color::Red));
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x + WALL_WIDTH + DOOR_WIDTH, topLeft.y - WALL_HEIGHT), sf::Vector2f(WALL_THICKNESS, WALL_HEIGHT), sf::Color::Red));
	// Right
	...
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x + (WALL_WIDTH * 2) + DOOR_WIDTH, topLeft.y + WALL_HEIGHT), sf::Vector2f(WALL_WIDTH, WALL_THICKNESS), sf::Color::Red));
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x + (WALL_WIDTH * 2) + DOOR_WIDTH, topLeft.y + WALL_HEIGHT + DOOR_WIDTH), sf::Vector2f(WALL_WIDTH, WALL_THICKNESS), sf::Color::Red));
	// Bottom
	...
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x + WALL_WIDTH - WALL_THICKNESS, (topLeft.y + WALL_HEIGHT * 2) + DOOR_WIDTH), sf::Vector2f(WALL_THICKNESS, WALL_HEIGHT), sf::Color::Red));
	entityManager->Add(new EntityWall(sf::Vector2f(topLeft.x + WALL_WIDTH + DOOR_WIDTH, (topLeft.y + WALL_HEIGHT * 2) + DOOR_WIDTH), sf::Vector2f(WALL_THICKNESS, WALL_HEIGHT), sf::Color::Red));
}
